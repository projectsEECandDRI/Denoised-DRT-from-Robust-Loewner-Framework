...
% an R-2(RC)-RL Equivalent Circuit Model (ECM) containing two RC elements
% and an RL element in series with ohmic resistance.
%
...
stem(abs(tau_i_LF),real(R_i_LF),'-.^','filled','color',[1 0 0],...
